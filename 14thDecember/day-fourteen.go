...
var inputFile = flag.String("inputFile", "14thDecember/input.txt", "Relative file path to use as input.")
...
outer:
	...
	// Second Part 
	// Continue from the First Part, except now treat maxY+2 as impassable.
outerB:
	for {
		loc := source
	innerB:
